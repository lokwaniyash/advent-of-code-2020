...
function checkAdjacent(i, j, set) {
  ...
  for (let k = 0; k < check.length; k++) {
    let result = nextInSight(i, j, check[k][0], check[k][1], set);
  ...
  for (let k = 0; k < found.length; k++) {
    if (set[found[k][0]][found[k][1]] == "#") {
      occ++;
    } else if (set[found[k][0]][found[k][1]] == "L") {
      unocc++;
    }
    // console.log(set[(found[k][0], found[k][1])]);
  }

  // console.log(found, occ, unocc);
...
function nextInSight(i, j, di, dj, set) {
  let reali = i,
    realj = j;
  while (true) {
    let seati = i + di;
    ...
    if (
      ...
      seati >= set.length ||
      seatj < 0 ||
      seatj >= set[seati].length
    ) {
      return [reali, realj];
    }

    if (set[seati][seatj] == "#" || set[seati][seatj] == "L") {
      return [seati, seatj];
    }
...
// let tempSet = seats.slice(0);

// for(let i = 0; i < seats.length; i++) {
//   for(let j = 0; j < seats[i].length; j++) {
//     let str = seats[i].slice(0);
//     str = str.split("");
//     if (tempSet[i][j] == "L" && checkAdjacent(i, j, tempSet)[0] < 1) {
//       str[j] = "#";
//       // console.log(i, j, str);
//     }
//     // str[j] = "#";
...
// // round 2
//
// tempSet = seats.slice(0);
//
// for(let i = 0; i < seats.length; i++) {
//   for(let j = 0; j < seats[i].length; j++) {
//     let str = seats[i].slice(0);
//     str = str.split("");
//     console.log(checkAdjacent(i, j, tempSet), i, j);
//     if (tempSet[i][j] == "#" && checkAdjacent(i, j, tempSet)[0] > 4) {
//       str[j] = "L";
//       // console.log(i, j, str);
//     }
//     // str[j] = "#";
